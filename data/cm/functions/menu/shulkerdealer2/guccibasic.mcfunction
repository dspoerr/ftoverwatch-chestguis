...
execute if score @s FortCurrency >= gss_guccibasic guccishulkershop run give @s shulker_box{display:{Name:"[{\"text\":\"Gucci Basic\",\"italic\":false,\"color\":\"light_purple\"}]",Lore:["[{\"text\":\"The classic handbag\",\"italic\":false,\"color\":\"dark_purple\"}]","[{\"text\":\"for the classic\",\"italic\":false,\"color\":\"dark_purple\"}]","[{\"text\":\"swagger. \",\"italic\":false,\"color\":\"dark_purple\"}]"]}}

...
execute if score bool chest_menu matches 0 if score @s chest_menu matches 1 run function cm:menu/chest1/directory
...
# refresh all chests.
# TO DO:
# Consider restricting the update to only the chest in use
function cm:menu/chest1/update
function cm:menu/shulkerdealer1/update
function cm:menu/shulkerdealer2/update
